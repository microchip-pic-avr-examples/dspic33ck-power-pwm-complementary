...
#include "hal_pinmap.h" // Include local mcal layer header file        
...
// Device Pin #35 is RB4 => Alternative Label to Programming Pin "PGC"
    ...
    #define ECP51_WR               PGC_WR      
    #define ECP51_RD               PGC_RD      
    ...
    #define ECP51_IS_ANALOG_INPUT  PGC_IS_ANALOG_INPUT
    #define ECP51_INIT_OUTPUT      PGC_INIT_OUTPUT  
    #define ECP51_INIT_INPUT       PGC_INIT_INPUT   

// Device Pin #46 is RB6 => Alternative Label to SPI Clock Pin "SCL"
    #define ECP53_TRIS             SCL_TRIS    
    #define ECP53_WR               SCL_WR      
    #define ECP53_RD               SCL_RD      
    ...
    #define ECP53_IS_ANALOG_INPUT  SCL_IS_ANALOG_INPUT
    #define ECP53_INIT_OUTPUT      SCL_INIT_OUTPUT  
    #define ECP53_INIT_INPUT       SCL_INIT_INPUT   

// Device Pin #12 is RD13 => Alternative Label to Debug Pin "DBGPIN"
    #define ECP54_TRIS             DBGPIN_TRIS    
    #define ECP54_WR               DBGPIN_WR      
    #define ECP54_RD               DBGPIN_RD      
    ...
    #define ECP54_RP               DBGPIN_SET     
    #define ECP54_SET              DBGPIN_SET
    #define ECP54_CLEAR            DBGPIN_CLEAR   
    #define ECP54_TOGGLE           DBGPIN_TOGGLE  
    #define ECP54_IS_ANALOG_INPUT  DBGPIN_IS_ANALOG_INPUT
    #define ECP54_INIT_OUTPUT      DBGPIN_INIT_OUTPUT
    #define ECP54_INIT_INPUT       DBGPIN_INIT_INPUT

// Device Pin #45 is RB5 => Alternative Label to SPI Pin "SDA2"
    #define ECP55_TRIS             SDA_TRIS    
    #define ECP55_WR               SDA_WR      
    #define ECP55_RD               SDA_RD      
    ...
    #define ECP55_IS_ANALOG_INPUT  SDA_IS_ANALOG_INPUT
    #define ECP55_INIT_OUTPUT      SDA_INIT_OUTPUT  
    #define ECP55_INIT_INPUT       SDA_INIT_INPUT   

// Device Pin #34 is RB3 => Alternative Label to Programming Pin "PGD"
    #define ECP56_TRIS             PGD_TRIS    
    #define ECP56_WR               PGD_WR      
    #define ECP56_RD               PGD_RD      
    ...
    #define ECP56_IS_ANALOG_INPUT  PGD_IS_ANALOG_INPUT
    #define ECP56_INIT_OUTPUT      PGD_INIT_OUTPUT  
    #define ECP56_INIT_INPUT       PGD_INIT_INPUT   
